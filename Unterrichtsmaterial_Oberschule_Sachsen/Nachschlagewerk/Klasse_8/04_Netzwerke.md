...
Damit Daten an das richtige Ziel gelangen, benötigen Geräte Adressen. In IP-Netzwerken werden dafür **IP-Adressen** verwendet. Menschen nutzen im Internet häufig Namen wie `example.org`; ein **DNS-System** hilft dabei, solche Namen den passenden IP-Adressen zuzuordnen.
...
**DNS:** System zur Zuordnung von Namen zu IP-Adressen.

**IP-Adresse:** Adresse eines Geräts beziehungsweise Netzwerkanschlusses in einem IP-Netzwerk.
